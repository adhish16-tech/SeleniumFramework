...
//	
//	@FindBy(css = ".ng-animating")
//	WebElement spinner;  // ✅ added to wait for loading overlay
//	
//	public void waitForElementToAppear(By findBy) {
//		
//		WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(5));
...
//			System.out.println("Overlay already gone or not found.");
//		}
//		// 🔐 Wait until cartHeader is clickable (ensures click isn't intercepted)
//	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
...
//	    }
//
//	    // 🔥 Wait until orderHeader is clickable
//	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//	    wait.until(ExpectedConditions.elementToBeClickable(orderHeader));
//	    orderHeader.click();
//
...
//	}
//
//	// NEW Method (better spinner handling)
//	public void waitForOverlayToDisappear() {
//		try {
//	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
//	wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".ngx-spinner-overlay")));
